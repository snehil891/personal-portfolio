              ...
              <div className="content">
                ...
                <p>
                  <ul className="unorderd-list">
                    ...
                    <li>
                      Troubleshooting salesforce problems Relationship & Process
                      automation
                    </li>
                  </ul>
                </p>
                <a href="https://smartinternz.com/internships/salesforce_certificates/8573535d757b48469f147c9552f30f84" className="cerf-button" target="blank" rel="norefferer">View Certificate</a>
              </div>
            </div>
          </div>
        </div>
